        ...
        <div class="modal-body">
          <form class="form-group text-center" action="" autocomplete="off">
            ...
            <div class="form-group mt-3" id="keys">
              <input class="input" type="tel" id="key1" maxlength="1" onkeyup="onKeyUp(this, 'key2')" />
              <input class="input" type="tel" id="key2" maxlength="1" onkeyup="onKeyUp(this, 'key3')" />
              <input class="input" type="tel" id="key3" maxlength="1" onkeyup="onKeyUp(this, 'key4')" />
              <input class="input" type="tel" id="key4" maxlength="1" onkeyup="onKeyUp(this, 'comprobar')" />
            </div>
            <div class="form-group mt-3 d-none" id="keys-false">
              <input class="input"  maxlength="1" value="*" readonly/>
              <input class="input"  maxlength="1" value="*" readonly/>
              <input class="input"  maxlength="1" value="*" readonly/>
              <input class="input"  maxlength="1" value="*" readonly/>
            </div>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", () => {
      ...
      function generarEnviarCodigo() {
        ...
        parametros.append("idusuario", idusers);
      ...
      function validarClave() {
        ...
        parametros.append("idusuario", idusers); // Aquí debe ser "idusers" en lugar de "idusuario"
