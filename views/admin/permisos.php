...
$permisos = [
  "A" => ["admin.view.php", "libros.view.php", "prestamos.view.php", "docente.view.php","perfil.view.php","categoria.view.php",
          "subcategoria.view.php", "edit-pdf.php", "edit-frontpage.php", "report.php"],
