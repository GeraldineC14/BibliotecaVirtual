                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 ">
                        <div class="d-flex justify-content-center gap-2 col-6 mx-auto">
                            ...
                            <div class="d-none d-md-inline-block mt-2 text-center">
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <div class="d-flex justify-content-center align-items-center w-100">
                                <div class="btn-group" role="group">
                                    ...
                                    <button class="btn btn-success btn-sm d-none d-md-inline-block" role="button" data-toggle="modal" data-target="#modal-usuarios">
                        ...
                        <div class="d-flex justify-content-center align-items-center mx-auto d-md-none mr-2 mb-2" style="max-width: 250px;">
                            <div class="btn-group" role="group">
                                <!-- Botón para mostrar el modal de registrar libro (versión móvil) -->
                                <a class="btn btn-outline-success btn-sm d-inline-block mr-2" role="button" data-toggle="modal" data-target="#modal-usuarios" data-target="#modal-libros-editar" id="mostrar-modal-registro" href="#">
                                    <i class="fa-solid fa-user-plus fa-sm text-black fa-xl"></i>
                                    &nbsp;Registrar
                                </a>
                        ...
                        <!-- Botón para generar código de verificación de estudiante -->
                        <div class="d-flex justify-content-center">
                            <div class="input-group mt-2 codigo mx-auto" style="max-width: 300px;">
                                <input type="text" class="form-control" id="codigohzg" readonly>
                                <div class="input-group-append">
                                    <button class="btn btn-outline-warning" type="button" id="generar">Generar</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" id="guardar-contraseña" class="btn btn-sm btn-primary">Guardar</button>
