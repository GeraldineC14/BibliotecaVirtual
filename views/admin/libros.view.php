                ...
                <div class="card shadow">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header bg-primary text-light">
                                    <h5 class="modal-title" id="titulo-modal-reporte">Generar Reporte</h5>
                                ...
                                <div class="modal-body">
                                    <form>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control select2" id="filtro-categoria" multiple>
                                        </div>
                                        <div class="form-group">
                                            <label for="filtro-subcategoria">Sub Categoría:</label>
                                            <input class="form-control select2" id="filtro-subcategoria" multiple>
                                        </div>
                                        <div class="form-group">
                                            <label for="filtro-estado">Estado:</label>
                                            <input class="form-control select2" id="filtro-estado" multiple>
                                        </div>
                                    </form>
                                </div>
                    ...
                    <div class="modal fade" data-backdrop="static" data-keyboard="false" id="modal-libros" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header bg-primary text-light">
                                    <h5 class="modal-title" id="titulo-modal-libros">Registrar Libro
                                    </h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span class="text-light" aria-hidden="true">&times;</span>
                                    </button>
