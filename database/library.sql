...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-08-2023 a las 23:37:39
...
--
-- Estructura de tabla para la tabla `hzgstudentcodes`
--
...
--
-- Volcado de datos para la tabla `hzgstudentcodes`
--
...
--
-- Estructura de tabla para la tabla `validacioncorreo`
--
...
--
-- Volcado de datos para la tabla `validacioncorreo`
--
...
--
-- Indices de la tabla `hzgstudentcodes`
--
ALTER TABLE `hzgstudentcodes`
...
ALTER TABLE `recuperarclave`
  ...
  ADD KEY `fk_idusuario_rcl` (`idusers`);
...
--
-- Indices de la tabla `validacioncorreo`
--
ALTER TABLE `validacioncorreo`
...
--
ALTER TABLE `books`
  MODIFY `idbook` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=312;
...
--
ALTER TABLE `commentaries`
  MODIFY `idcommentary` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT de la tabla `hzgstudentcodes`
--
ALTER TABLE `hzgstudentcodes`
  MODIFY `idcodes` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `loans`
--
ALTER TABLE `loans`
  MODIFY `idloan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT de la tabla `recuperarclave`
--
ALTER TABLE `recuperarclave`
  MODIFY `idrecuperar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `subcategories`
--
ALTER TABLE `subcategories`
  MODIFY `idsubcategorie` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
-- AUTO_INCREMENT de la tabla `validacioncorreo`
--
ALTER TABLE `validacioncorreo`
...
--
ALTER TABLE `recuperarclave`
  ADD CONSTRAINT `fk_idusuario_rcl` FOREIGN KEY (`idusers`) REFERENCES `users` (`idusers`);
